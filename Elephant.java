public class Elephant extends Animal
{
    ...
    private String limbs = "four legs";

    private String habitat = "savannah and forests";

    Elephant(){}

    Elephant(String name, String species)
    {
        this.name = name;
        this.species = species;
    }

    Elephant(String name, String species,String sound,String limbs, String habitat)
    {
        this.name = name;
        this.species = species;
        this.sound =sound;
